...
export const isTutorialOneActiveSelector = (state: ReduxState) =>
  s(state).isTutorialOneActive;
...
export const currentFirebaseToken = (state: ReduxState) =>
  s(state).firebaseToken;

export const userVerifiedDates = (state: ReduxState) => s(state).verifiedDates;

// Smart precition selectors
export const isFuturePredictionSelector = (state: ReduxState) =>
  predictionS(state);
...
export const dailyCardLastUsed = (state: ReduxState) =>
  s(state)?.dailyCardLastUsed;

export const isHapticActiveSelector = (state: ReduxState) =>
  s(state).isHapticActive;
