...
import { toPromise as l, take as h, filter as k, subscribe as y, map as m, tap as x, merge as g, mergeMap as w, takeUntil as E, make as O, onPush as N, share as b, fromPromise as q, fromValue as _, makeSubject as D, lazy as S, onStart as P, switchMap as R, publish as V, takeWhile as A, onEnd as M } from "wonka";
...
function withPromise(e) {
  var source$ = r => e(r);
  source$.toPromise = () => l(h(1)(k((e => !e.stale && !e.hasNext))(source$)));
...
var cacheExchange = ({forward: e, client: r, dispatchDebug: t}) => {
  ...
  return i => {
    ...
    var c = x((e => {
      ...
      cacheOutcome: "miss"
    }) : e))(g([ m(mapTypeNames)(k((e => !shouldSkip(e) && !isOperationCached(e)))(i)), k((e => shouldSkip(e)))(i) ])))));
    return g([ s, c ]);
  };
};
...
export { C as Client, a as CombinedError, cacheExchange, composeExchanges, Q as createClient, f as createRequest, debugExchange, mapExchange as errorExchange, fetchExchange, formatDocument, gql, s as makeErrorResult, makeOperation, n as makeResult, mapExchange, c as mergeResultPatch, ssrExchange, t as stringifyDocument, subscriptionExchange };
