  ...
  const processedSearchBarOptions = React.useMemo(() => {
    if (_reactNative.Platform.OS === 'android' && searchBar && !searchBar.disableBackButtonOverride) {
      const onFocus = function () {
        ...
        (_searchBar$onFocus = searchBar.onFocus) === null || _searchBar$onFocus === void 0 || _searchBar$onFocus.call(searchBar, ...args);
      };
      const onClose = function () {
        ...
        (_searchBar$onClose = searchBar.onClose) === null || _searchBar$onClose === void 0 || _searchBar$onClose.call(searchBar, ...args);
      };
      return {
        ...searchBar,
        onFocus,
