...
export const ru: AppTranslations = {
  ...
  // prediction change
  daily_card_and_period_info: 'Быстрый переход к дневным карточкам и информации о месячных',
  period_day_cloud: 'Облако дня месячных',
  no_period_day_cloud: 'Облако дня без месячных',
  green_btn_with_two_arrows: 'Зеленая кнопка с 2 стрелками для перехода вверх и вниз',
