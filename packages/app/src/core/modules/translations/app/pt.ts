...
export const pt: AppTranslations = {
  ...
  // -------------------------Error messages-----------------------------
  username_too_short:
    "O nome de utilizador é muito curto, mínimo de 3 caracteres",
  ...
  secret_error_content:
    "Precisará de responder a esta pergunta se esquecer a sua senha.",
  ...
  reset_password_question:
    "Para redefinir a sua senha, precisa de inserir a sua resposta secreta",
  change_secret: "alterar pergunta \nsecreta",
  error_connect_guest: "Erro ao conectar o convidado",
  error_same_name:
    "Há um utilizador com o mesmo nome. Altere o seu nome e tente novamente.",
  ...
  daily_card_and_period_info:
    "Atalho para cartões diários e informações do período",
