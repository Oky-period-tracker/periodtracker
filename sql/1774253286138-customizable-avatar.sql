...
COMMENT ON COLUMN oky_user.avatar IS 'Custom avatar configuration with keys: body, hair, eyes, smile, clothing, devices (string array, or null), skinColor, hairColor, eyeColor (all string or null), customAvatarUnlocked (boolean, default false), name (string or null).';
...
-- Example of valid avatar JSON structure
-- {
--   "body": "body-medium",
--   "hair": "01",
--   "eyes": "00",
