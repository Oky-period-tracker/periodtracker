...
export const HairOptions: React.FC<HairOptionsProps> = ({
  ...
  const handleHairColorScroll = React.useCallback(
    (event: any) => {
  ...
  const handleHairColorScrollEnd = React.useCallback(
    (event: any) => {
  ...
  const handleHairColorSelect = React.useCallback(
    (color: string) => {
  ...
  const handleHairStyleScrollEnd = React.useCallback(
    (event: any) => {
  ...
  const handleHairStyleSelect = React.useCallback(
    (item: string) => {
          ...
          <View style={styles.arrowButtons}>
            ...
            >
              <FontAwesome
                name="chevron-left"
                size={16}
                color={hairColorPage === 0 ? '#ccc' : '#000000'}
              />
            </TouchableOpacity>
            <TouchableOpacity
              ...
              style={[
                styles.arrowButton,
                hairColorPage >= maxHairColorPage && styles.arrowButtonDisabled,
              ]}
            ...
            >
              <FontAwesome
                name="chevron-right"
                size={16}
                color={hairColorPage >= maxHairColorPage ? '#ccc' : '#000000'}
              />
            </TouchableOpacity>
          </View>
        </View>
            ...
            {HAIR_COLORS.map((color, index) => (
              <TouchableOpacity
                ...
                accessibilityLabel={
                  ...
                  `: hair color ${translate(
                    HAIR_COLOR_NAMES[color] || 'customizer_hair_color_unknown',
                  )}, ${avatarSelection.hairColor === color ? 'selected' : 'tap to select'}`
                }
                accessibilityRole="button"
              />
            ))}
          ...
          <View style={styles.arrowButtons}>
            ...
            >
              <FontAwesome
                name="chevron-right"
                size={16}
                color={isHairStyleNextDisabled ? '#ccc' : '#000000'}
              />
            </TouchableOpacity>
          </View>
        </View>
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      accessibilityLabel={
                        ...
                        `: hairstyle ${item}, ${isSelected ? 'selected' : 'tap to select'}`
                      }
                      accessibilityRole="button"
                    >
