...
export const en: AppTranslations = {
  ...
  birth_info:
    "We ask you this as it helps us make better predictions about your monthly cycle, and help us make sure we're reaching the right audience.",
  ...
  tutorial_0:
    "Hi! I'm your friend. I'm here for you every step of the way! To show me love, give me a tap! Now, let me give you a quick tour of Oky.",
  tutorial_1:
    'This circle represents your monthly cycle - the amount of time between each of your periods.',
  tutorial_2:
    "Each shape (cloud, star...) represents a day of the month. Today's date is always in the middle of the screen.",
  tutorial_3:
    'This number shows you how many days Oky thinks there are until your next period, or if you are on your period, how many days until it ends!',
  ...
  tutorial_7:
    "Or, if Oky thinks your period is over, but it is actually still happening, tap the 'Period Day' shape!",
  tutorial_8:
    "And if Oky predicted you would have your period, but actually you didn't, then tap the 'No Period' shape!",
  tutorial_9:
    "Each day, track how you feel and what you did using the Diary cards! Swipe right to get to the next card. This improves Oky's predictions and helps you learn more about yourself...",
  tutorial_10:
    "The first card in your Daily Diary is a summary of your day, showing the date, how far you are in your cycle, and how many stars you've won for that day.",
  tutorial_11:
    'On the other cards, track your mood, flow, body and activities. Do it every day to win Oky stars!',
  tutorial_12: "We've made it easy to track how you feel and what you did - just pick an emoji!",
  tutorial_13:
    'This is your space to write anything you like, from private thoughts to what you did each day!',
  tutorial_14:
    'Tap this button to view your whole month at a glance and start noticing patterns in your body and mood.',
  ...
  share_period_details_heading:
    'Tell Oky about your period to get better predictions. Did you have your period today?',
  day_card_mood: 'Mood',
  day_card_body: 'Body',
  ...
  survey_description:
    "Let's get to know you! This info stays between us, but you can swipe left if you don't want to answer.",
  ...
  fertile_popup:
    'Oky uses the information you give to make predictions about your period days and your ovulation time. But it is information only, and not a reliable prediction of your fertile days.',
  ...
  haptic_request: 'Vibrations',
  sound_request: 'Sounds',
  ...
  search_city: 'city',
  // HelpCenter
  find_help_center: 'Find a service provider',
  saved_help_center: 'Saved service providers',
  filter_to_search: 'I am looking for',
  filter_to_search2: 'In',
  loading: 'Loading...',
  empty_saved: `Oops, we couldn't find any of your saved service providers`,
  empty_hc: `Oops, we couldn't find any service providers using your search terms!`,
  empty_hc_2: `Try narrowing down or 'x'ing' some categories to improve the search.`,
  you_are_not_alone: `You're not alone!`,
  // confirmation_modal
  cm_wait: 'Just a moment!',
  cm_wait_message1: 'You need an internet connection to open this website.',
  cm_wait_message2: 'Do you want to continue?',
  cm_button_cancel: 'No',
  cm_button_proceed: 'Continue',
  cm_wait_message1_2: 'You need load to call this number',
}
