...
const PredictionEngineContext = React.createContext<
  PredictionEngine | undefined
>(undefined);
...
export function usePredictionDispatch() {
  ...
  if (context === undefined) {
    throw new Error(
      `usePredictionDispatch must be used within a PredictionProvider`
    );
  }
  return context;
}
...
export function usePredictionEngine() {
  ...
  if (context === undefined) {
    throw new Error(
      `usePredictionEngine must be used within a PredictionProvider`
    );
  }
  return context;
}
...
export function useUndoPredictionEngine() {
  ...
  if (context === undefined) {
    throw new Error(
      `useUndoPredictionEngine must be used within a PredictionProvider`
    );
  }
  return context;
}

export function useCalculateFullInfoForDateRange(
  startDate: Moment,
  endDate: Moment
) {
