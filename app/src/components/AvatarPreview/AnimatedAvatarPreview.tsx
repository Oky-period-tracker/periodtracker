    ...
    const startAnimation = setTimeout(() => {
      try {
        ...
        const eyesSequence = withSequence(
          ...
          withTiming(0, {
            duration:
              jumpDuration + pauseBetween + leftHandDuration + pauseBetween + rightHandDuration,
        ...
        const jumpSequence = withSequence(
          ...
          withTiming(0, {
            duration:
              leftHandDuration + pauseBetween + rightHandDuration + eyesDuration + pauseBetween,
            easing: Easing.linear,
          }),
        )
        ...
        const leftHandSequence = withSequence(
          ...
          withTiming(0, {
            duration: rightHandDuration + eyesDuration + pauseBetween + jumpDuration + pauseBetween,
            easing: Easing.linear,
          }),
        )
        ...
        rightHandRotation.value = withDelay(
          eyesDuration +
            ...
            pauseBetween +
            leftHandDuration +
            pauseBetween, // After all previous + waits
