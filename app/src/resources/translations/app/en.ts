...
export const en: AppTranslations = {
  ...
  profile_title: 'Your Oky profile',
  profile_subtitle: 'Click here to change your settings',
  track_regularly_cycle_updates: 'Enter your period days and your cycle predictions get better',
  ...
  select_avatar_title: "Let's get started!",
  select_avatar_subtitle: 'First select your Oky friend.',
  choose_avatar: 'Choose your avatar',
  select_avatar_title_unlocked: 'Your Oky friend!',
  select_avatar_subtitle_unlocked: 'Select your Oky friend.',
  select_avatar_reminder_locked: 'Want to create your own Oky friend? Use Oky regularly and enter your period days for three cycles in a row to unlock this feature.\n\nThe more you enter, the better Oky can predict your periods.',
  select_avatar_reminder_unlocked_not_created: 'You can create your own Oky friend just the way you like,\ntap on your friend to start.',
  select_avatar_reminder_unlocked_created: 'You can change to another Oky friend anytime you like.',
  avatar_message_enter_period_days: 'Enter your period days to open the locks.',
  avatar_message_keep_entering_period_days: 'Keep entering your period days to unlock the new Oky friend feature.',
  ...
  select_theme_title: 'Your background',
  select_theme_subtitle: 'Choose your favourite background.',
  customizer_title: 'Your friend.',
  customizer_subtitle: 'Build your own Oky friend.',
  customizer_tutorial: 'Tutorial',
  customizer_first_visit_tooltip: "Let's take a quick tour to learn how to build your Oky friend!",
  customizer_skin: 'Skin',
  customizer_body: 'Body',
  customizer_hair: 'Hair',
  customizer_hair_color: 'Hair color',
  customizer_hairstyle: 'Hairstyle',
  customizer_eyes: 'Eyes',
  customizer_eye_color: 'Eye color',
  ...
  customizer_tutorial_step2_text: 'Tap the color buttons to change skin, hair or eye color.\n\nUse the arrows or swipe to see more options. Tap to choose a color.',
  customizer_tutorial_step3_title: 'See more options',
  customizer_tutorial_step3_text: 'To see more options use arrows or swipe for more colors.',
  ...
  avatar_naming_modal_title: "You're all set! Give your friend a name!",
  avatar_naming_modal_placeholder: "Type your friend's name",
  avatar_naming_modal_hint: 'Remember you can change this later.',
