import { SecureActions } from '../types'
...
function surveysReducer(state = {}, action: SecureActions): AnswerForUserState['surveys'] {
...
function quizzesReducer(state = {}, action: SecureActions): AnswerForUserState['quizzes'] {
...
function cardsReducer(state = {}, action: SecureActions): AnswerForUserState['cards'] {
...
function notesReducer(state = {}, action: SecureActions): AnswerForUserState['notes'] {
...
const answerForUserReducer = combineReducers<AnswerForUserState, SecureActions>({
...
export function answerReducer(state: AnswerState = {}, action: SecureActions): AnswerState {
  // TODO_ALEX: survey
  if (action.type === 'ANSWER_SURVEY') {
    return {
      ...state,
