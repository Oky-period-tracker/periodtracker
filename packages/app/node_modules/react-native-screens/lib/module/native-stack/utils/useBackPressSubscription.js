...
export function useBackPressSubscription(_ref) {
  ...
  const clearSubscription = React.useCallback(function () {
    ...
    (_subscription$current = subscription.current) === null || _subscription$current === void 0 || _subscription$current.remove();
  ...
  const createSubscription = React.useCallback(() => {
    if (!isDisabled) {
      ...
      (_subscription$current2 = subscription.current) === null || _subscription$current2 === void 0 || _subscription$current2.remove();
