...
export const en: StaticContent = {
  ...
  articles: {
    byId: {
      ...
      'ee1d06d6-b2a7-477e-9e9d-ff3591e78b57': {
        ...
        content:
          "Abstinence can mean different things to different people. When Oky talks about abstinence, we mean not not having vaginal, oral, or anal sexual intercourse. But you might still have 'outercourse' - doing sexual things like kissing and touching.\r\n\r\nSome people say abstinence is not doing anything sexual at all with another person even kissing. \r\n\r\nYou can choose to be abstinent whenever you want, even if you've had sex before.",
        category: 'Family planning',
        subCategory: 'Contraception',
        live: false,
      },
  ...
  helpCenters: [
    {
      ...
      address: '123, Road Street, Town, PL8 4TQ ',
      website: 'https://www.facebook.com/NationalPsychologyCenter/,example.com,',
      subRegion: '',
      region: '',
      lang: 'en',
    ...
    },
    {
      ...
      lang: 'en',
      isAvailableNationwide: true,
      primaryAttributeId: 8,
      otherAttributes: '7,9,10',
      isActive: true,
      sortingKey: 5,
    },
    {
  ...
  helpCenterAttributes: [
    { id: 1, emoji: '💊', attributeName: '💊 Medicine', name: 'Medicine' },
    {
      id: 2,
      emoji: '🏥',
  ...
  avatarMessages: [
    ...
    },
    {
      ...
      content:
        "Are your periods irregular? ⏰  That's totally normal — and why Oky predictions aren't always correct!",
      live: false,
    },
    {
