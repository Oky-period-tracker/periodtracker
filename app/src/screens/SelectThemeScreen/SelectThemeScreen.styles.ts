 ...
 * @param themeConfig UI configuration
 * @param isInitialSelection Is the screen in onboarding or not
 * @param hasGoBack Include go back button
 * @returns Styles
 */
export const createSelectThemeScreenStyles = (
