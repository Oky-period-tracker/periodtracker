...
export const fr: AppTranslations = {
  ...
  avatar_amp_themes_login:
    "Choisissez votre camarade sur Oky et votre image de fond !",
  ...
  settings_info:
    "Choisir la langue, définir la localisation ou accéder à un tutoriel.",
  ...
  survey_question_3:
    "Tu te souviens combien de jours ont duré tes dernières règles ?",
  survey_question_4:
    "Est-ce que tu sais combien de semaines il y a entre tes règles ?",
  ...
  // -------------------------Error messages-----------------------------
  username_too_short:
    "Le nom que vous utiliserez pour vous connecter à Oky.3 caractères minimum",
  ...
  error_same_name:
    "Il y a un utilisateur avec le même nom, il faut le changer et réessayer.",
  ...
  green_btn_with_two_arrows:
    "Bouton vert avec 2 flèches pour monter et descendre",
